<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryAllLendRecord.aspx.cs" Inherits="QueryAllLendRecord" %>
...
<body >
    ...
    <img src="top.png" style="width:100%"/>
        ...
        <div style="margin-top:5%;margin-left:20%;align-items:center">
            <asp:GridView ID="GridView" runat="server" DataSourceID="LendRecord" AutoGenerateColumns="False"
                  AllowPaging="True"  
            CssClass="mGrid"
            ...
            AlternatingRowStyle-CssClass="alt">
                <Columns>
                    ...
                    <asp:BoundField DataField="book_finish" HeaderText="是否还书" SortExpression="book_finish" />
                </Columns>
            </asp:GridView>
            <asp:SqlDataSource ID="LendRecord" runat="server" ConnectionString="<%$ ConnectionStrings:LibrarySystemConnectionString %>" SelectCommand="SELECT BaseInf.user_name, LendBook.user_id, LendBook.dead_date, LendBook.start_date, LendBook.book_name, LendBook.book_type, LendBook.book_number,LendBook.book_finish FROM BaseInf INNER JOIN LendBook ON BaseInf.user_id = LendBook.user_id" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
