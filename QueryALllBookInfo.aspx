<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryALllBookInfo.aspx.cs" Inherits="QueryALllBookInfo" %>
...
<body >
    ...
    <img src="top.png" style="width:100%"/>
        ...
        <div style="margin-left:30%;margin-top:5%;">
            <asp:GridView ID="GridView1" runat="server" DataSourceID="AllBookInfo" AutoGenerateColumns="False"
             AllowPaging="True"  
            CssClass="mGrid"
            ...
            AlternatingRowStyle-CssClass="alt">
                <Columns>
                    ...
                    <asp:BoundField DataField="book_total" HeaderText="书本总数" SortExpression="book_total" />
                    <asp:BoundField DataField="book_free" HeaderText="可借书本" SortExpression="book_free" />
                </Columns>
            </asp:GridView>
            <asp:SqlDataSource ID="AllBookInfo" runat="server" ConnectionString="<%$ ConnectionStrings:LibrarySystemConnectionString %>" SelectCommand="SELECT * FROM [LibraryBook]" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
            <br />
            <asp:Button ID="BookInsertBtn" runat="server" Text="图书入库" Height="40px" Width="150px" OnClick="BookInsertBtn_Click" />
            <asp:Button ID="BookDeleteBtn" runat="server" Text="图书出库" Height="40px" Width="150px" OnClick="BookDeleteBtn_Click"  />
            <br />
            <br />
            <asp:Label ID="DeleteBookLabel" runat="server" Text="请输入要出库的书名:" Font-Size="Large" Visible="false"></asp:Label>
            <asp:TextBox ID="DeleteBookName" runat="server" Font-Size="Large" Visible="false"></asp:TextBox>
            <br />
            <br />
          <asp:Label ID="BookAuthorLabel" runat="server" Text="请输入书的作者:" Font-Size="Large" Visible="false"></asp:Label>
            &nbsp; &nbsp; &nbsp; &nbsp; 
            <asp:TextBox ID="BookAuthorName" runat="server" Font-Size="Large" Visible="false"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="DeleteBook" runat="server" Text="出库" Height="40px" Width="150px"  Visible="false" OnClick="DeleteBook_Click" />
        </div>
    </form>
</body>
</html>
