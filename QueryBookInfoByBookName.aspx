<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryBookInfoByBookName.aspx.cs" Inherits="QueryBookInfoByBookName" %>
...
<body >
    ...
    <img src="top.png" style="width:100%"/>
        ...
        <div style="margin-left:40%;margin-top:5%">
            <asp:Label ID="Label1" runat="server" Text="请输入书名:" Font-Size="Large"></asp:Label>
            <asp:TextBox ID="BookName" runat="server" Font-Size="Large"></asp:TextBox>
            <br />
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="BtnQueryBookInfo" runat="server" Text="查询书目" Height="40px" Width="150px"/>
        </div>
        <div style="margin-left:40%;margin-top:2%">
            <asp:GridView ID="GridView1" runat="server" DataSourceID="BookInfoByBookName" AutoGenerateColumns="False"
                  AllowPaging="True"  
            CssClass="mGrid"
            ...
            <asp:SqlDataSource ID="BookInfoByBookName" runat="server" ConnectionString="<%$ ConnectionStrings:LibrarySystemConnectionString %>" SelectCommand="SELECT * FROM [LibraryBook] WHERE ([book_name] = @book_name)" ProviderName="System.Data.SqlClient">
                <SelectParameters>
                    <asp:ControlParameter ControlID="BookName" Name="book_name" PropertyName="Text" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </form>
